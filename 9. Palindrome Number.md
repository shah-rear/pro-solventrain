Certainly! If you want to organize the code snippets for Visual Studio Code, you can use Markdown format. Below is the content organized for VS Code:
...
Note: You can copy and paste this markdown content into a new file with a `.md` extension, and it should render well on GitHub.